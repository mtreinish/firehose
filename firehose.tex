...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item All the community infrastructure runs on donated public cloud resources
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Standard Maintained by OASIS
        \item Lightweight design, low bandwidth, and designed to handle unreliable networking
...
\begin{frame}
    ...
    \Wider[4em]{\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}MQTT Brokers}
        \usebeamerfont{normal text}\usebeamercolor[fg]{normal text}

    \begin{itemize}
        \item Relies on a central broker
...
\begin{frame}
    \frametitle{MQTT Topics and Subscriptions}
        \begin{itemize}
        ...
        \end{itemize}
    \vspace{5mm}
    \Wider[4em]{\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}Examples:}
        \usebeamerfont{normal text}\usebeamercolor[fg]{normal text}
...
\begin{frame}
    ...
    \begin{itemize}
        \item 3 QoS Levels:\\
            ...
            \end{itemize}
        \item QoS of a message sent with each PUBLISH
        \item Client sends QoS with SUBSCRIBE
    \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{columns}[T]
        \begin{column}{.48\textwidth}
            \textbf{CPU Usage:}\\
            \vspace{10mm}
            \includegraphics[width=1.1\textwidth]{manual_load_cpu_usage.png}
        \end{column}
        \begin{column}{.48\textwidth}
            \textbf{Memory Usage:}\\
            \vspace{10mm}
            \includegraphics[width=1.1\textwidth]{manual_load_ram_usage.png}
        \end{column}
    \end{columns}
\end{frame}
