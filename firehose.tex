...
\begin{frame}
	\frametitle{Firehose}
    \begin{itemize}
        \item An infra run MQTT broker
        \item Has public readonly access via MQTT and MQTT over Websockets on Port 80
        \item 
    \end{itemize}
\end{frame}
...
\subsection{Services Using the Firehose}
\begin{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Zuul Subscriber Support to gerrit
        \item Add addtional publishers:
            \begin{itemize}
                \item Ansible
                \item Nodepool
                \item Logstash
